...
export function RegisterForm({
  ...
  // (Auto verify handled inline in onChange of OTP components now)
            ...
            <form onSubmit={handleSubmit} className="grid gap-6">
              ...
              {!formData.email && (
                <p className="text-xs text-muted-foreground">
                  You can skip adding an email for now and add it later in
                  settings.
                </p>
              )}
            </form>
                ...
                {isPhoneSent && !isPhoneVerified && (
                  <div className="grid gap-2">
                    <InputOTP
                      ...
                      onChange={(val) => {
                        setPhoneCode(val);
                        if (val.length === 6) verifyPhoneCode();
                      }}
                    ...
                    <p className="text-xs text-muted-foreground">
                      Code sent. Auto-verifies when complete. Std messaging
                      rates may apply.
                    </p>
                  </div>
                )}
  ...
  return (
    <div
      ...
      {...props}
    >
      <Card className="rounded-2xl w-full max-w-md min-h-[640px] flex flex-col">
